...
class Lensmark_Photodata {
	 ...
	 * @since	1.0.0
	 */
	function lensmark_add_photodata_approval_field( $form_fields, $post ) {
		$parent_post = get_post( $post->post_parent );
		if ( 'photopost' !== $parent_post->post_type ) {
			return $form_fields;
		}
	 ...
	 * @since	1.0.0
	 */
	function lensmark_save_photodata_approval_field( $post, $attachment ) {
